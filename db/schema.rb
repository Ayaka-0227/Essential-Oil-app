...
ActiveRecord::Schema[8.0].define(version: 2026_05_10_001000) do
  ...
  create_table "contact_inquiries", force: :cascade do |t|
    ...
    t.datetime "admin_reply_read_at"
    t.index ["admin_reply_read_at"], name: "index_contact_inquiries_on_admin_reply_read_at"
    t.index ["created_at"], name: "index_contact_inquiries_on_created_at"
    t.index ["replied_at"], name: "index_contact_inquiries_on_replied_at"
